...
The user's device generates Trust Packets using the device authority model defined in RFC 1300.
...
The verifier evaluates Trust Packets according to the rules defined in RFC 2001.
...
The device signs the Trust Packet Hash defined in RFC 2001.
...
Verifiers must perform the validation steps defined in RFC 2001 before allowing execution.
...
## 12. Use-Case Profiles

This document defines the core, use-case-neutral authorization flow. Deployment-specific bindings are specified as companion profiles in the 5000 series rather than as branches of this document:

- UniKey RFC 5004 — SMTP / Email Transport Profile
- Payments, API-gateway/HTTP, and enterprise-application profiles are planned.

Profiles constrain or extend this flow for a deployment context. Profiles MUST NOT alter the pre-execution ordering, fail-closed verification, or scope containment requirements defined here.
...
- generates Trust Packets as defined in RFC 2001
- uses device authority defined in RFC 1300
